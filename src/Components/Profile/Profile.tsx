...
export default function Profile({ activeStateSkills }: Props) {
      ...
      <div className="container">
        ...
        <Skills>
          ...
          <Bar>
            ...
            <Parent>
              <Span1
                style={activeStateSkills ? percHTML : percsR}
              ></Span1>
            </Parent>
          </Bar>
          ...
          <Bar>
            ...
            <Percentage>100%</Percentage>
            <Parent>
              <Span1 style={activeStateSkills ? percCSS : percsR}></Span1>
            </Parent>
          </Bar>
          ...
          <Bar>
            ...
            <Parent>
              <Span1
                style={activeStateSkills ? percJavaScript : percsR}
              ></Span1>
            </Parent>
          </Bar>
          ...
          <Bar>
            ...
            <Parent>
              <Span1
                style={activeStateSkills ? percReact : percsR}
              ></Span1>
            </Parent>
          </Bar>
          ...
          <Bar>
            ...
            <Parent>
              <Span1
                style={activeStateSkills ? percAngular : percsR}
              ></Span1>
            </Parent>
          </Bar>
          ...
          <Bar>
            ...
            <Parent>
              <Span1
                style={activeStateSkills ? percFlutter : percsR}
              ></Span1>
            </Parent>
          </Bar>
        </Skills>
